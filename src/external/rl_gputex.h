    ...
    if (file_data_ptr != NULL)
    {
        ...
        else
        {
            ...
            *height = header->height;
            ...
            if (*width % 4 != 0) RAYLIB_LOG("WARNING: IMAGE: DDS file width must be multiple of 4. RaylibImage will not display correctly");
            if (*height % 4 != 0) RAYLIB_LOG("WARNING: IMAGE: DDS file height must be multiple of 4. RaylibImage will not display correctly");
